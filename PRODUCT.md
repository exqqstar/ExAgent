...
- Codex Desktop: project/session workbench structure, agent event visibility, approval flow placement.
- Linear: dense but polished product UI, restrained color, sharp hierarchy, predictable controls.
